#ifndef __LOGICAL_EXPRESSION_HPP
#define __LOGICAL_EXPRESSION_HPP
...
{                                             \
public:                                        \
explicit DLL_LOCAL objName( std::shared_ptr<LogicalExp>l, std::shared_ptr<LogicalExp>r ); \
DLL_LOCAL ~objName() override = default;    \
DLL_LOCAL bool Eval( Context& c ) override;   \
...
namespace Logic
{
    ...
    public:
        ...
        [[nodiscard]] DLL_LOCAL std::wstring ToWString() const override{ return varName; }
    ...
    {
    public:
        DLL_LOCAL BinaryOp(  std::shared_ptr<LogicalExp> l, std::shared_ptr<LogicalExp> r );
        DLL_LOCAL ~BinaryOp() override = default;
        [[nodiscard]] DLL_LOCAL std::wstring ToWString() const override;
    protected:
        std::shared_ptr<LogicalExp> left,
                                    right;
    };
